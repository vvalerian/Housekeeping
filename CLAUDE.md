...
- **Lot 3 livré** : authentification (comptes employeurs, PIN tablette, sessions, cloisonnement des routes) + espace employeur `/admin` complet (SPEC §7).
- Lot 4 (hors ligne, PWA, kiosque tablette) : à venir, cf. SPEC §11.
